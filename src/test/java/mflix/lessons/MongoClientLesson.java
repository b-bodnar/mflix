...
public class MongoClientLesson extends AbstractLesson {
  ...
  private String uri = "mongodb+srv://m220student:m220password@mflix-ykqcc.mongodb.net/test?retryWrites=true&w=majority&maxPoolSize=50";
  ...
  public void DocumentInstance() {
    ...
    */
    ...
    document = new Document("name", new Document("first", "Norberto")
            .append("last", "Leite"));
